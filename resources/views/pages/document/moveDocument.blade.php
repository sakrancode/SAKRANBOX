{!! Form::model($document, [
                          'route' => ['document.updateMoveDocument', $document->id],
                          'method' => 'PUT',
                          'name' => 'formMoveDocument',
                          'id' => 'formMoveDocument',
                          'enctype' => 'multipart/form-data',
                          'class' => 'form-horizontal form-prevent-multiple-submits', 'target' => '']) !!}

<div class="modal-header">
  <h4 class="modal-title">Move Document - [{{$document->name}}]</h4>
...
<div class="modal-footer justify-content-between">
  ...
  <button type="submit" class="btn btn-primary button-prevent-multiple-submits">
      <i class="spinner fa fa-spinner fa-spin"></i> Move Data
  </button>
</div>
